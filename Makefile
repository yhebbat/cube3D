SRC =	cub3d.c ft_atoi.c ft_check.c ft_draw.c ft_initialisation.c \
		...
		ft_free.c ft_substr.c ft_save_all.c ft_maperror.c
...
$(NAME):
	...
	@ar rc $(NAME) $(OBJECT)
	@ranlib $(NAME)
	@gcc cub3d.c $(NAME) -g3 -fsanitize=address -I /usr/local/include -L /usr/local/lib -lmlx -framework OpenGL -framework AppKit -o cub3D -O3 -g3
